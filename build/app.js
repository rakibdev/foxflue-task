...
// directives.js
var addListeners = (element, events, func, options = {}) => {
  events.split(" ").forEach((event) => {
    element.addEventListener(event, func, options[event]);
  });
};
var removeListeners = (element, events, func) => {
  events.split(" ").forEach((event) => {
    element.removeEventListener(event, func);
  });
};
var showRipple = (event) => {
  ...
  ripple2.style.height = ripple2.style.width;
  ripple2.style.left = x - radius + "px";
  ripple2.style.top = y - radius + "px";
  const ripple_container = document.createElement("div");
  ripple_container.className = "ripple-container";
  ripple_container.appendChild(ripple2);
  element.appendChild(ripple_container);
  const ripple_animation = ripple2.animate({ transform: ["scale(0.1)", "scale(1)"] }, 400);
  const hide_events = {
  ...
  const hideRipple = async () => {
    ...
    const hide_animation = ripple2.animate({ opacity: [getComputedStyle(ripple2).opacity, 0] }, { duration: 100, fill: "forwards" });
...
var useState = () => toRefs(state);

// vue-script:/home/rakib/Downloads/foxflue-task/components/map.vue?type=script
var map_default = {
  __name: "map",
  setup(__props) {
    ...
    const getAddressPosition = async (address) => {
      const response = await fetch(`http://api.positionstack.com/v1/forward?access_key=58ec0925cdd441256bbf914e2cdd609b&query=${address}`);
    ...
    const getCurrentPosition = () => {
      return new Promise((resolve2) => {
        navigator.geolocation.getCurrentPosition((location) => {
          resolve2({ lat: location.coords.latitude, lng: location.coords.longitude });
        });
      });
    };
    ...
    window.onMapsLoaded = async () => {
      map2 = new google.maps.Map(map_ref.value, {
        zoom: 8,
        minZoom: 1,
      ...
      if (!navigator.geolocation)
        return console.warn("Geolocation API is not available");
    ...
    const loadGoogleMaps = () => {
      ...
      script.src = "https://maps.googleapis.com/maps/api/js?key=AIzaSyCNSwQBpPvd_ZuR93-_Et2o8MvMsHR7CeY&callback=onMapsLoaded&v=weekly";
      script.async = true;
...
// components/map.vue
var map_default2 = map_default;
map_default.__scopeId = "data-v-7c954670";

// vue-script:/home/rakib/Downloads/foxflue-task/components/camera.vue?type=script
var _withScopeId = (n) => (pushScopeId("data-v-b96f302e"), n = n(), popScopeId(), n);
var _hoisted_1 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("h3", { class: "title" }, "Camera", -1));
...
var camera_default = {
  ...
  setup(__props, { expose }) {
    ...
    onMounted(() => {
      video_ref.value.addEventListener("canplay", (event) => {
        if (!streaming) {
          const height2 = video.videoHeight / (video.videoWidth / width);
          video_ref.value.setAttribute("width", width);
          video_ref.value.setAttribute("height", height2);
          canvas_ref.setAttribute("width", width);
          canvas_ref.setAttribute("height", height2);
          streaming = true;
        }
      }, false);
    });
    const onClickOutside = () => {
      dialog_ref.value.animate({ transform: ["scale(1)", "scale(1.03)", "scale(1)"] }, { duration: 180 });
    };
    expose({ open });
    return (_ctx, _cache) => {
      const _component_btn = resolveComponent("btn");
      return openBlock(), createElementBlock("div", {
        class: normalizeClass(["dialog-root", { open: opened.value }]),
        onClick: _cache[1] || (_cache[1] = withModifiers(($event) => onClickOutside(), ["self"]))
      }, [
        createBaseVNode("div", {
          class: "dialog",
          ref_key: "dialog_ref",
          ref: dialog_ref,
          style: normalizeStyle({ width: _ctx.fullscreen ? "" : _ctx.width })
        }, [
          _hoisted_1,
          createBaseVNode("div", _hoisted_2, [
            createBaseVNode("video", {
              ...
              ref: video_ref,
              autoplay: ""
            }, "Video stream not available.", 512),
          ...
          createBaseVNode("div", _hoisted_3, [
            createVNode(_component_btn, {
              label: "Cancel",
              onClick: _cache[0] || (_cache[0] = ($event) => opened.value = false)
            }),
            createVNode(_component_btn, {
              label: "Capture",
              onClick: capture
...
var camera_default2 = camera_default;
camera_default.__scopeId = "data-v-b96f302e";

// vue-script:/home/rakib/Downloads/foxflue-task/app.vue?type=script
var _withScopeId2 = (n) => (pushScopeId("data-v-56d62ce8"), n = n(), popScopeId(), n);
var _hoisted_12 = { class: "list outlined" };
var _hoisted_22 = /* @__PURE__ */ _withScopeId2(() => /* @__PURE__ */ createBaseVNode("div", { class: "label-wrapper" }, [
  /* @__PURE__ */ createBaseVNode("p", { class: "body-small" }, "Customer"),
  /* @__PURE__ */ createBaseVNode("p", { class: "label" }, "Christopher Nunez"),
  /* @__PURE__ */ createBaseVNode("p", { class: "body-small" }, "+1 (516) 812-9200")
], -1));
var _hoisted_32 = { class: "label-wrapper" };
var _hoisted_4 = /* @__PURE__ */ _withScopeId2(() => /* @__PURE__ */ createBaseVNode("p", { class: "body-small" }, "Pickup address", -1));
var _hoisted_5 = { class: "label" };
var _hoisted_6 = {
  key: 0,
  class: "body-small primary-label"
};
var _hoisted_7 = /* @__PURE__ */ _withScopeId2(() => /* @__PURE__ */ createBaseVNode("span", { class: "icon" }, "pin_drop", -1));
var _hoisted_8 = { class: "options" };
var _hoisted_9 = { class: "devices" };
var _hoisted_10 = { class: "header" };
var _hoisted_11 = /* @__PURE__ */ _withScopeId2(() => /* @__PURE__ */ createBaseVNode("span", { class: "icon" }, "smartphone", -1));
var _hoisted_122 = /* @__PURE__ */ _withScopeId2(() => /* @__PURE__ */ createBaseVNode("h3", { class: "title" }, "Devices", -1));
var _hoisted_13 = { class: "list outlined" };
var _hoisted_14 = ["src"];
var _hoisted_15 = { class: "label-wrapper" };
var _hoisted_16 = { class: "label" };
var _hoisted_17 = { class: "description body-small" };
var _hoisted_18 = { class: "body-small primary-label" };
var _hoisted_19 = { class: "header" };
var _hoisted_20 = /* @__PURE__ */ _withScopeId2(() => /* @__PURE__ */ createBaseVNode("span", { class: "icon" }, "update", -1));
var _hoisted_21 = /* @__PURE__ */ _withScopeId2(() => /* @__PURE__ */ createBaseVNode("h3", { class: "title" }, "Payments", -1));
var _hoisted_222 = { class: "list" };
var _hoisted_23 = { class: "label-wrapper" };
var _hoisted_24 = /* @__PURE__ */ _withScopeId2(() => /* @__PURE__ */ createBaseVNode("div", { class: "label" }, "Subtotal", -1));
var _hoisted_25 = { class: "description body-small" };
var _hoisted_26 = /* @__PURE__ */ _withScopeId2(() => /* @__PURE__ */ createBaseVNode("li", null, [
  /* @__PURE__ */ createBaseVNode("div", { class: "label-wrapper" }, [
    /* @__PURE__ */ createBaseVNode("div", { class: "label" }, "Payment Method"),
    /* @__PURE__ */ createBaseVNode("div", { class: "description body-small" }, [
      /* @__PURE__ */ createTextVNode(" Cashapp: "),
      /* @__PURE__ */ createBaseVNode("span", { class: "primary-label" }, "$scga12")
    ])
  ])
], -1));
var _hoisted_27 = /* @__PURE__ */ _withScopeId2(() => /* @__PURE__ */ createBaseVNode("div", { class: "label-wrapper" }, [
  /* @__PURE__ */ createBaseVNode("div", { class: "label" }, "Total")
], -1));
var app_default = {
  __name: "app",
  setup(__props) {
    ...
    const subtotal = computed2(() => devices.value.reduce((previous, current) => previous.price + current.price));
    const options = [
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        createBaseVNode("section", null, [
          createVNode(map_default2),
          createVNode(camera_default2, {
            ref_key: "camera_ref",
            ref: camera_ref
          }, null, 512),
          createBaseVNode("div", null, [
            createVNode(_component_chip, { label: "Offer #T216" }),
            createVNode(_component_chip, { label: "Pending payment" }),
            createVNode(_component_chip, { label: "Assigned" })
          ]),
          createBaseVNode("ul", _hoisted_12, [
            ...
            createBaseVNode("li", null, [
              createBaseVNode("div", _hoisted_32, [
                _hoisted_4,
                createBaseVNode("p", _hoisted_5, toDisplayString(unref(pickup_address)), 1),
                unref(pickup_distance) ? (openBlock(), createElementBlock("p", _hoisted_6, [
                  _hoisted_7,
                  createTextVNode(" " + toDisplayString(unref(pickup_distance)) + " miles away from my location ", 1)
                ])) : createCommentVNode("v-if", true)
              ]),
              createVNode(_component_btn, { label: "GO" })
            ])
          ]),
          createBaseVNode("div", _hoisted_8, [
            (openBlock(), createElementBlock(Fragment, null, renderList(options, ({ label, icon }) => {
              return createVNode(_component_btn, {
                "secondary-label": label,
                icon
              }, null, 8, ["secondary-label", "icon"]);
            }), 64))
          ])
        ]),
        createBaseVNode("section", _hoisted_9, [
          createBaseVNode("header", _hoisted_10, [
            _hoisted_11,
            _hoisted_122,
            createVNode(_component_btn, { icon: "more_horiz" })
          ]),
          createBaseVNode("ul", _hoisted_13, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(devices), ({ label, image, features, price }) => {
              return openBlock(), createElementBlock("li", null, [
                ...
                createBaseVNode("div", _hoisted_15, [
                  createBaseVNode("div", _hoisted_16, toDisplayString(label), 1),
                  createBaseVNode("div", _hoisted_17, toDisplayString(features.join(" - ")), 1),
                  createBaseVNode("div", _hoisted_18, "Estimated offer $" + toDisplayString(price), 1)
                ]),
                createVNode(_component_btn, {
                  label: "Start inspection",
                  onClick: _cache[0] || (_cache[0] = ($event) => camera_ref.value.open())
                })
              ]);
            }), 256))
          ])
        ...
        createBaseVNode("section", null, [
          ...
          createBaseVNode("ul", _hoisted_222, [
            createBaseVNode("li", null, [
              createBaseVNode("div", _hoisted_23, [
                _hoisted_24,
                createBaseVNode("div", _hoisted_25, toDisplayString(unref(devices).length) + " Devices", 1)
              ]),
              createTextVNode(" $" + toDisplayString(unref(subtotal)), 1)
            ]),
            _hoisted_26,
            createBaseVNode("li", null, [
              _hoisted_27,
...
app_default.__scopeId = "data-v-56d62ce8";

// vue-script:/home/rakib/Downloads/foxflue-task/components/button.vue?type=script
var _hoisted_110 = {
  key: 0,
...
var button_default = {
  ...
  setup(__props) {
    useCssVars((_ctx) => ({
      "3095fd76-color": __props.color
    }));
    return (_ctx, _cache) => {
      const _directive_ripple = resolveDirective("ripple");
      return withDirectives((openBlock(), createBlock(resolveDynamicComponent(__props.link ? "a" : "button"), {
        ...
        href: __props.link,
        type: __props.link ? null : "button",
        disabled: __props.disabled || __props.loading,
        style: normalizeStyle({ color: "var(--color)" })
      }, {
        default: withCtx(() => [
          __props.startIcon ? (openBlock(), createElementBlock("span", _hoisted_110, toDisplayString(__props.startIcon), 1)) : createCommentVNode("v-if", true),
          __props.icon?.length > 0 ? (openBlock(), createElementBlock("span", _hoisted_28, toDisplayString(__props.icon), 1)) : createCommentVNode("v-if", true),
          createTextVNode(" " + toDisplayString(__props.label) + " ", 1),
          renderSlot(_ctx.$slots, "default"),
          __props.endIcon ? (openBlock(), createElementBlock("span", _hoisted_33, toDisplayString(__props.endIcon), 1)) : createCommentVNode("v-if", true)
        ]),
        _: 3
      }, 8, ["class", "href", "type", "disabled", "style"])), [
        [_directive_ripple]
      ]);
    };
  }
...
// vue-script:/home/rakib/Downloads/foxflue-task/components/chip.vue?type=script
var chip_default = {
  __name: "chip",
  props: {
    label: [String, Number],
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      ...
      return openBlock(), createBlock(_component_btn, {
        class: "chip",
        filled: __props.selected,
        label: __props.label,
        "start-icon": __props.startIcon
      }, null, 8, ["filled", "label", "start-icon"]);
    };
  }
};

// components/chip.vue
var chip_default2 = chip_default;

// vue-script:/home/rakib/Downloads/foxflue-task/components/dialog.vue?type=script
var dialog_default = {};
...
app.component("btn", button_default2);
app.component("chip", chip_default2);
app.component("dialog-view", dialog_default2);
app.mount(".app");
